...
<header class="navbar">
    ...
    <div class="kepek1">
    <img src="kepek/IMG_20180606_120005-1080x675.jpg" height="550" width="1000">
    </div>

    <div class="p1">
        <h1>Real Steel H6 Plus<br><br></h1>
        <p>Szerző: Vaszilij | 2018. jún. 17. | Kések, Folder, Real Steel<br><br>A Real Steel H6 Plus azok közé a kések közé tartozik, amiket biztosan nem vettem volna meg, ha nem írnám ezt a blogot. Nincsenek fenntartásaim a márkával, ár/érték arányban nagyon jó késeket gyártanak, de a dizájnjaik nagy része engem nem fog meg. (Vannak persze...</p>
    </div>

    <div class="kepek2">
        <img src="kepek/img_20170406_165027.jpg" height="550" width="1000">
    </div>

    <div class="p2">
        <h2>Real Steel G3 Puukko Duplex<br><br></h2>
        <p>Szerző: Vaszilij | 2017. ápr. 6. | Kések, Real Steel, Uncategorized<br><br><br>Első késbemutatóm alanyául a legújabb szerzeményemet, egy Real Steel G3 Puukkot választottam, abból is a Duplex leélezésű verziót. A késnek jelenleg kétféle változata érhető el, az egyik ez, a másik skandi leélezéssel készült. A két bicska között különbség még a...</p>
    </div>
