...
<header class="navbar">
    ...
    <div class="kepek1">
    <img src="kepek/IMG_20211019_132620-1080x675.jpg" height="550" width="1000">
    </div>

    <div class="p1">
        <h1>MKM Isonzo<br><br></h1>
        <p>Szerző: Vaszilij | 2021. okt. 31. | Kések, Folder, MKM<br><br>MKM Isonzo MKM Isonzo. Igazából nem is kellene tovább írnom, mert úgyis tudtok mindent: a késblogger újabb próbálkozása, hogy megtalálja a tökéletes Voxnaes-dizájnt. Sőt, igazából Vaszilij helyét átvette egy mesterséges intelligencia, ami – vagy aki – az...</p>
    </div>

    <div class="kepek2">
        <img src="kepek/IMG_20190602_161022-1080x675.jpg" height="550" width="1000">
    </div>

    <div class="p2">
        <h2>MKM Clap<br><br></h2>
        <p>Szerző: Vaszilij | 2019. jún. 23. | Kések, Folder, MKM<br><br><br>Az MKM Clap több szempontból érdekes zsebkés. A megvásárlása épp ezért szembemegy a késbeszerzési alapelveimmel, ugyanis eddigi tapasztalataim szerint az ilyen, kevéssé ismert márkák modelljeit nehéz eladni, legalábbis jelentős veszteség nélkül. Mégis megfogott benne...</p>
    </div>
