...
<header class="navbar">
    ...
    <div class="kepek1">
    <img src="kepek/IMG_20191227_140545-980x735.jpg" height="550" width="1000">
    </div>

    <div class="p1">
        <h1>Zero Tolerance 0609<br><br></h1>
        <p>Szerző: Vaszilij | 2020. márc. 15. | Kések, Folder, Zero Tolerance<br><br>Zero Tolerance 0609 A Zero Tolerance 0609 az egyik olyan kés volt, amit megláttam egy videóban, és tudtam, hogy kell nekem. Elsőre persze a dizájn fogott meg, de a kés technikai paraméterei is meggyőzőek voltak. Egyedül az ára nem tetszett, de némi rágódás után úgy...</p>
    </div>

    <div class="kepek2">
        <img src="kepek/IMG_20180530_111725-e1535726753703-1080x675.jpg" height="550" width="1000">
    </div>

    <div class="p2">
        <h2>Zero Tolerance 0566 bemutató<br><br></h2>
        <p>Szerző: Vaszilij | 2018. aug. 31. | Kések, Folder, Zero Tolerance<br><br><br>Vannak késmárkák, amelyeket egyfajta legenda övez, és ha az ember belekóstol ebbe a hobbiba, netán hagyja, hogy magával is ragadja, előbb-utóbb késztetést érez, hogy ezen kések egyikét-másikát birtokolja. Meglehet, hogy nem lesz ezekből életre szóló szerelem, vagy...</p>
    </div>
