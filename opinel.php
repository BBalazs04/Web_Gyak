...
<header class="navbar">
    ...
    <div class="kepek1">
    <img src="kepek/IMG_20200118_151141-1080x675.jpg" height="550" width="1000">
    </div>

    <div class="p1">
        <h1>Opinel – Tényleg csak egy kés?<br><br></h1>
        <p>Szerző: Vaszilij | 2020. jan. 19. | Kések, Folder, Opinel<br><br>Opinel – Tényleg csak egy kés? Opinel. Aki egy ideje foglalkozik késekkel, az biztosan belefutott már a márkába. Lehet szeretni, lehet utálni, de lehetetlen figyelmen kívül hagyni. Sokáig halogattam, hogy írjak ezekről a késekről, mert vannak nálam sokkal...</p>
    </div>
