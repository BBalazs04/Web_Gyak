...
<header class="navbar">
    ...
    <div class="kepek1">
    <img src="kepek/img_20180123_093346.jpg" height="550" width="1000">
    </div>

    <div class="p1">
        <h1>Y – START LK5011 bemutató<br><br></h1>
        <p>Szerző: Vaszilij | 2018. febr. 4. | Kések, Folder, Y-Start<br><br>Ebben a bejegyzésben ismét egy kínai kést szeretnék bemutatni nektek, A Y-Start LK5011-es modelljt. A cég egy másik kését, a Jin02-ről már olvashattatok itt, az azzal szerzett pozitív tapasztalataim miatt rendeltem meg ezt a példányt, annak ellenére, hogy ez a...</p>
    </div>

    <div class="kepek2">
        <img src="kepek/img_20170909_1218251.jpg" height="550" width="1000">
    </div>

    <div class="p2">
        <h2>Y-Start JIN02<br><br></h2>
        <p>Szerző: Vaszilij | 2017. szept. 16. | Írások, Kések, Y-Start<br><br><br>Úgy tűnik, a kínaiak már nem csak a spájzban vannak, hanem elő is jöttek belőle, és már valahol a nappali környékén sertepertélnek. Engem is meglepet, hogy a jó néhány évvel ezelőtti negatív tapasztalataim a kínai késekkel kapcsolatban – egy Enlan Bee modellt...</p>
    </div>
