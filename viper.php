...
<header class="navbar">
    ...
    <div class="kepek1">
    <img src="kepek/IMG_20200328_140544-980x735.jpg" height="550" width="1000">
    </div>

    <div class="p1">
        <h1>Viper Odino<br><br></h1>
        <p>Szerző: Vaszilij | 2020. ápr. 12. | Kések, Folder, Viper<br><br>Viper Odino A Viper Odino már első pillantásra is egy fura szerzet. Az általam kipróbált verzió a carbon fiber és titán markolattal, a letisztult dizájnnal egy gentleman’s foldernek tűnik, a paraméterei azonban már-már egy keményebb felhasználásra szánt...</p>
    </div>
